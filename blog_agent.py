...
[1단계] 위 기사 중 정치와 무관한, 순수 경제/부동산 시장/재테크 이슈만 골라 그중 블로그 독자가 가장 관심 가질 화제성 있는 주제 2개를 골라라.
- 정치인 발언, 정당/여야 갈등, 선거, 국회 관련 뉴스는 "경제" 키워드로 걸렸어도 제외
- 순수 시장/정책/투자 관점의 내용(집값, 금리, 대출, 세제, 청약, 주식, 환율 등)만 대상
